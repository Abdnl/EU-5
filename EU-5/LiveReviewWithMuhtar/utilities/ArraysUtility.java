...
public class ArraysUtility {
	...
	public static int[] merge(int[] arr1, int[] arr2) {
		int[] arr3 = new int[arr1.length + arr2.length]; // Make sure that this array can contain all the elements of
															// arr1 & arr2
	...
	public static double[] merge(double[] arr1, double[] arr2) {
		double[] arr3 = new double[arr1.length + arr2.length]; // Make sure that this array can contain all the elements
																// of arr1 & arr2
		int i = 0; // will represents the index numbers of third array
	...
	public static char[] merge(char[] arr1, char[] arr2) {
		char[] arr3 = new char[arr1.length + arr2.length]; // Make sure that this array can contain all the elements of
															// arr1 & arr2
		int i = 0; // will represents the index numbers of third array
	...
	public static String[] merge(String[] arr1, String[] arr2) {
		String[] arr3 = new String[arr1.length + arr2.length]; // Make sure that this array can contain all the elements
																// of arr1 & arr2
		int i = 0; // will represents the index numbers of third array
