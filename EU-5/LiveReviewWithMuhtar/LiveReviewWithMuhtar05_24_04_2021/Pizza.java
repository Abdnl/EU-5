package LiveReviewWithMuhtar05_24_04_2021;
...
public class Pizza {
	...
	public String toString() {
		return "Pizza [size=" + size + ", cheeseTopping=" + cheeseTopping + ", pepperoniTopping=" + pepperoniTopping
				+ ", total price=$" + calculatePrice() + "]";
	}

}
/*
 * Pizza: attribute: size cheeseTopping pepperoniTopping Actions: setInfo(),
 * calculatePrice(), toString() assume that: size: small ==> $10 medium ==> $12
 * large ==> $14 one cheese topping 1$ one pepperoni topping 2$
 */
