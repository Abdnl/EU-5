...
public class ArrayListPractice1 {
	...
	public static void main(String[] args) {
		 ...
		 * } // WE HAVE TO APPLY Iterable to remove objects from Collection during the
		 * iteration
		 */
		...
		String[] countryNames = { "United States Of America", "Untited Kingdom", "Turkey", "Japan", "Korea", "Russia" };

		ArrayList<String> countries = new ArrayList<>(Arrays.asList(countryNames));

		System.out.println(countries);

		countries.removeIf(p -> p.length() > 10); // if the length of the object is greater than 10, then reomve it from
													// arraylist
		...
		String[] jobTitles = { "SDET", "SDET", "QA", "QA", "QE", "BA", "PO", "SM", "PO", "Data Analyst", "DEV", "QA",
				"QA" };
